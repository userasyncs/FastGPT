...
专心小智 系统插件和用户工作台的插件效果是一致的，所以你需要提前了解“插件”的定义和功能。

在 专心小智 中，插件是一种特殊的工作流，它允许你将一个工作流封装起来，并自定义入口参数和出口参数，类似于代码里的 “子函数”。

1. ### 跑通 专心小智 dev 环境

需要在 dev 环境下执行下面的操作。

1. ### 在 专心小智 工作台中，创建一个插件
