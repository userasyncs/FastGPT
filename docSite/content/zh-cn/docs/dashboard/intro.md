---
title: "工作流&插件"
description: "快速了解 专心小智 工作流和插件的使用"
icon: "extension"
draft: false
toc: true
weight: 226
...
专心小智的工作流从【流程开始】节点开始执行，可以理解为从用户输入问题开始，没有**固定的出口**，是以节点运行结束作为出口，如果在一个轮调用中，所有节点都不再运行，则工作流结束。
...
1. 为了方便连接，专心小智 每个节点的上下左右都有连接点，左和上是前置线连接点，右和下是后置线连接点。
